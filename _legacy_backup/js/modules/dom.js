...
export const dom = {
    ...
    rampPlaneAreaStatsContainer: document.getElementById('ramp-plane-area-stats-container'), // <-- 新增
    ...
    suggestFloorPremiumBtn: document.getElementById('suggest-floor-premium-btn'),
