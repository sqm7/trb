...
import { PermissionTableModal } from '@/components/admin/PermissionTableModal';
...
export default function AdminMembersPage() {
    ...
    const filteredMembers = members.filter(m => {
        ...
        if (currentUserRole !== 'super_admin' && m.role === 'super_admin') return false;

        return m.email?.toLowerCase().includes(searchQuery.toLowerCase()) ||
