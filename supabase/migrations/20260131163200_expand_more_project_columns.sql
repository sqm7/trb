...
BEGIN
    ...
    LOOP
        ...
        EXECUTE format('
            ...
            ADD COLUMN IF NOT EXISTS affiliated_companies text,
        ...
        EXECUTE format('
            ...
            COMMENT ON COLUMN public.%I.affiliated_companies IS ''關係企業'';
            COMMENT ON COLUMN public.%I.construction_license IS ''建造號碼'';
        ', table_name, table_name, table_name, table_name, table_name, table_name, table_name, table_name, table_name, table_name, table_name, table_name, table_name, table_name, table_name);
